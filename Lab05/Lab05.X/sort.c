...
int main(void)
{
    ...
    ListItem *temp = LinkedListNew("help");
    temp = LinkedListCreateAfter(temp, "me");
    temp = LinkedListCreateAfter(temp, "fuckme");
    temp = LinkedListCreateAfter(temp, "hehe");
    LinkedListPrint(temp);
    
    
    LinkedListPrint(temp);
    int c = LinkedListSize(temp);
    printf("%d", c);
...
ListItem *SelectionSort(ListItem* list)
{
    ...
    ListItem *min = list;
    //ListItem *temp2 =LinkedListGetLast(list);
    while (list) {
        ListItem *min = list;
...
//        printf("\n");
        int i = LinkedListSwapData(min, list);
        // printf("%i ", i);
