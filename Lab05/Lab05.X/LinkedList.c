...
//
//    if (item == LinkedListGetLast(item)) {
...
//            temp1 = firstItem->data;
//            firstItem->data = NULL;
//            secondItem->data = temp1;
////            LinkedListCreateAfter(secondItem, temp1);
//
//
//
//
...
//        if (secondItem != NULL) {
//
//            temp1 = secondItem->data;
//            secondItem->data = NULL;
//            firstItem->data = temp1;
////            LinkedListCreateAfter(firstItem, temp1);
//
//
//
//        }
