...
static struct Timer TimerA = {FALSE, 2};
static struct Timer TimerB = {FALSE, 3};
static struct Timer TimerC = {FALSE, 5};
...
int main(void)
{
     ...
     **************************************************************************************************/
    printf("Welcome to vlguan's lab6 part1 (timers).  Compiled on %s %s.\n", __TIME__, __DATE__);
    LEDS_INIT();
...
void __ISR(_TIMER_1_VECTOR, ipl4auto) Timer1Handler(void)
{
    ...
    if (TimerB.timeRemaining == 0) {
        TimerB.timeRemaining = 3;
        TimerB.event = TRUE;
    }
    if (TimerC.timeRemaining == 0) {
        TimerC.timeRemaining = 5;
        TimerC.event = TRUE;
    }
